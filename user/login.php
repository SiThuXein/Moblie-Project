	...
	<div class="ads-grid py-sm-5 py-4">
		<div class="container py-xl-4 py-lg-2">
            ...
            if(isset($_POST["btn"])){
              ...
              $qry="select * from customer where username='$username' and password='$password'";
              $res=mysqli_query($db,$qry);
							...
							if($count>0){
								...
								echo "<script>window.location.href='checkuser.php'</script>";
							}else{
								echo "<label style='color:red;'>You're wrong Username and Password</label>";
							}
