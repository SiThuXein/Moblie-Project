    ...
    <div class="container-fluid">
        <form action="" method="post">
            ...
            <div class="row justify-content-center">
                <input value="<?php echo $brandname ?>" type="text" class="border border-primary" name="brand" id="">
                <input type="submit" class="btn btn-primary btn-sm ml-2 border border-primary" value="Update" name="btn">
            </div>
        </form>
    </div>
</body>
...
if (isset($_POST['btn'])) {
    ...
    $res = mysqli_query($db, $sql);
    if ($res) {
        echo "<script>window.alert('Brandname has been updated successfully!')</script>";
