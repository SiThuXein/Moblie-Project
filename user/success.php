...
<body>
	...
	<!-- shop locator (popup) -->
	<div class="services-breadcrumb"  style="margin-top:30px !important;">
	...
	<div class="ads-grid py-sm-5 py-4">
		<div class="container py-xl-4 py-lg-2">
			...
			<div class="row">
				<!-- product left -->
				<div class="agileinfo-ads-display col-sm-12">
						<!-- first section -->
							<h2>Dear Customer,&nbsp;<strong><i><span><?php if(!empty($_SESSION["username"])){echo $_SESSION["username"];} else {$_SESSION="";} ?></span></i></strong></h2>
							<p class="text-success lead">&nbsp; &nbsp; &nbsp; You successfully sumitted the following products.Thank for your shopping here!</p>
								...
								<tr>
										...
										<?php
										 ...
										 <div class="panel panel-default" >
										 	<div class="panel-heading">
										 		<h3><span class="glyphicon glyphicon-envelop">Customer's Information</span></h3>
										 	</div>
											<div class="panel-body pull-left" style="margin-top:20px;">
												<p style="color:black;font-size:20px;"> Name :<b> <?php echo $name ?></b></p>
												<p style="color:black;font-size:20px;">Phone : <b><?php echo $phone ?></b></p>
												<p style="color:black;font-size:20px;"> Address : <b> <?php echo $address ?></b></p>
											</div>
										 </div>
									</td>
									...
									<td>
										<table class="table table-striped">
											...
											<?php
												$total=0;
												$qry="select orderdetails.*,item.* from orderdetails left join item on orderdetails.itemid=item.itemid where orderdetails.orderid='$orderid'";
												$res=mysqli_query($db,$qry);
												foreach ($res as $item){
