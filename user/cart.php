				...
				<div class="table-responsive">
					...
					<table class="timetable_sub">
							...
							<?php
								...
								$sql="select * from item where itemid='$cid'";
							...
							<tr class="rem1">
								...
								<td class="invert-image">
									<a >
										<img src="../images/<?php echo $product ?>" class="img-fluid">
									</a>
								</td>
								<td class="invert">
									<div class="quantity">
										<div class="quantity-select">
											<a href="decrease.php?cid=<?php echo $itemid ?>" class="btn btn-sm btn-primary">-</a>
											<div class="entry value">
												<span style="color:black;"><?php echo $qty ?></span>
											</div>
											<a href="increase.php?cid=<?php echo $itemid ?>" class="btn btn-sm btn-primary" >+</a>
										</div>
									</div>
								</td>
								...
								<td class="invert">
										<a href="remove.php?cid=<?php echo $itemid ?>" class="btn btn-sm btn-primary">x</a>
								</td>
							</tr>
						<?php } ?>
						<div >
							<p style="font-size:17px; color:blue;">Total Amount is : $<?php echo $total ?></p>

						</div>

					</table><br><br>

<a href="checkuser.php"><button class="btn btn-primary" >Checkout</button> </a>
<a href="index.php"><button class="btn btn-primary">Shop more >></button> </a>
