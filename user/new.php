...
<body>
	...
	<!-- shop locator (popup) -->
	<div class="services-breadcrumb" style="margin-top:50px !important;">
		...
		<div class="container py-xl-4 py-lg-2">
			...
			<div class="row">
				<!-- product left -->
						...
						$qry="select * from item where itemname='Samsung Galaxy A71' ";
						 ...
						 <div class="col-md-4 product-men mt-5">
	 						<div class="men-pro-item simpleCart_shelfItem">
	 							<div class="men-thumb-item text-center">
	 								<img src="../images/<?php echo $photo ?>" alt="" class="img-fluid">
	 								<div class="men-cart-pro">
	 									<div class="inner-men-cart-pro">

	 										<a href="details.php?itemid=<?php echo $itemid ?>" class="link-product-add-cart">Quick View</a>
	 									</div>
	 								</div>
	 							</div>
	 							<div class="item-info-product text-center border-top mt-4">
	 								<h4 class="pt-1">
	 									<a href="single.php"><?php echo $itemname ?></a>
	 								</h4>
						...
						$qry="select * from item where itemname='Samsung Galaxy A51' ";
						$res=mysqli_query($db,$qry);
						foreach ($res as $ress){
							$itemid=$ress["itemid"];
							$itemname=$ress["itemname"];
						...
						$qry="select * from item where itemname='OnePlus 8 Pro' ";
						$res=mysqli_query($db,$qry);
						foreach ($res as $ress){
							$itemid=$ress["itemid"];
							$itemname=$ress["itemname"];
