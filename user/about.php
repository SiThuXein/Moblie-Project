					...
					<div class="row">
						...
						<div class="col-2 top_nav_right text-center mt-sm-0 mt-2">
							<div class="wthreecartaits wthreecartaits2 cart cart box_1">
								<form action="card.php" method="post" class="last">
		...
		<div class="container py-xl-4 py-lg-2">
			...
			<div class="row">
				<div class="col-lg-6 welcome-left">
					<h3>Welcome</h3>
					<h4 class="my-sm-3 my-2">Welcome to mmMobileSale where you can buy your favourite phones with one click.If you need anything,just hit the help button.</h4>
					<p>We make sure that our website have everything you need.mmMobileSale is the best place for people with the best taste. </p>
				</div>
			...
			<div class="row gallery-index">
				<div class="col-sm-6 med-testi-grid">
					<div class="med-testi test-tooltip rounded p-4">
						<p>"The best place to buy phones.I'm very satisfied.If you are seeking for the phones with the best quality then this is your place.Highly Recommended.</p>
					</div>
					<div class="row med-testi-left my-5">
						...
						<div class="col-lg-10 col-9 med-testi-txt">
							<h4 class="font-weight-bold mb-lg-1 mb-2">Min San</h4>
				...
				<div class="col-sm-6 med-testi-grid">
					<div class="med-testi test-tooltip rounded p-4">
						<p>"Suitable price,nice quality phones,wide range of choice and one of my fav shops.</p>
					</div>
					<div class="row med-testi-left my-5">
						<div class="col-lg-2 col-3 w3ls-med-testi-img">
							<img src="images/user.jpg" alt=" " class="img-fluid rounded-circle" />
						...
						<div class="col-lg-10 col-9 med-testi-txt">
							<h4 class="font-weight-bold mb-lg-1 mb-2">Phyo Phyo</h4>
				...
				<div class="col-sm-6 med-testi-grid">
					<div class="med-testi test-tooltip rounded p-4">
						<p>"I always buy phones there for me and for my family and for my colleagues. reasonable price and good services.</p>
					</div>
					<div class="row med-testi-left mt-sm-5 my-5">
						...
						<div class="col-lg-10 col-9 med-testi-txt">
							<h4 class="font-weight-bold mb-lg-1 mb-2">Hla Tin</h4>
				...
				<div class="col-sm-6 med-testi-grid">
					<div class="med-testi test-tooltip rounded p-4">
						<p>"Prices are fair compare with other shops.Their delivery service is better compare to other sites.Best place to buy phones.5 out of 5 stars.</p>
					</div>
					<div class="row med-testi-left mt-5">
						...
						<div class="col-lg-10 col-9 med-testi-txt">
							<h4 class="font-weight-bold mb-lg-1 mb-2">Wutt Yee</h4>
